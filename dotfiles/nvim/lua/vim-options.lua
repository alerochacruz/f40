...
vim.api.nvim_set_keymap('v', '<Leader>y', 'y:lua vim.cmd([[call system("xclip -sel clip -i -r", @")]])<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<Leader>yy', 'yy:lua vim.cmd([[call system("xclip -sel clip -i", trim(@0))]])<CR>', {noremap = true})
